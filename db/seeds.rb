...
event =Event.create(start_date: Faker::Date.forward(days: 23), duration: number.sample,description: Faker::TvShows::SiliconValley.motto , title: Faker::ChuckNorris.fact, price: rand(1..999), location: Faker::Address.city, admin: User.all.sample, attendee: Event.)
end
